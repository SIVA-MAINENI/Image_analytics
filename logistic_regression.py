# the output variable has to be 0/1 and the column should be labeled "binary" in the data file
# the text column should be the last column, and labeled "text"
# the input data file is to be specified in line 164
# the confusion matrix is shown in the output file called confusion.png
# Validation data scores will be in file Validation_LR.csv
import numpy
